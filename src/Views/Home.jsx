    ...
    <div>
      ...
      >
        <div className="my-3">
            ...
            <div className="col-3 ms-3">
              <div className="">
                ...
                >
                  ...
                  <span style={red}>M</span>e<span style={red}>N</span>ow
                </h1>
              </div>
            </div>
          ...
          <div className="text-white p-2 mt-3" style={backgroundColorDarkBlue}>
            <div className="row">
              <div
        ...
        <div className="row">
          <div className="col-6">
            <h2 style={colorDarkBlue}>
              <span style={red}>El sitio de empleo #1 </span> para encontrar
              trabajos - sin anuncios, estafas ni basura. Encuentra tu próximo
              trabajo en HireMeNow
            </h2>
            <div className="mt-5">
              <button
                className="btn btn-primary"
      ...
      <div>
        <h3 className="text-center mb-4">Lo que dicen nuestros miembros</h3>
